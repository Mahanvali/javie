    ...
    public void execute(SlashCommandInteractionEvent event){
        ...
        if(event.getSubcommandName().equals("xpgain")){
            ...
            Global.BuildSimpleDescriptionEmbed(
                "<:yukariNOTED:1270513272780619799> Sucessfully set the amount of xp gain per message to: `" + Global.basicXPGain + "`",
                Global.CUSTOMPURPLE,
                setEmbed);
        ...
        if(event.getSubcommandName().equals("cooldown")){
            ...
            if(messageOption != null){
                ...
                Global.BuildSimpleDescriptionEmbed(
                    "<:yukariNOTED:1270513272780619799> Sucessfully set the message xp cooldown to: `" + messageCooldownString + "`!",
                    Global.CUSTOMPURPLE,
                    setEmbed);
                event.getHook().sendMessageEmbeds(setEmbed.build()).queue();
            }
            ...
            if(voiceOption != null){
                ...
                Global.BuildSimpleDescriptionEmbed(
                    "<:yukariNOTED:1270513272780619799> Sucessfully set the voice xp cooldown to: `" + voiceCooldownString + "`!",
                    Global.CUSTOMPURPLE,
                    setEmbed);
                event.getHook().sendMessageEmbeds(setEmbed.build()).queue();
            }
